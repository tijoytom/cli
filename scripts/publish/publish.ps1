...
function UploadBinaries($zipFile)
{
    ...
    $zipBlob = "$env:CHANNEL/Binaries/$env:DOTNETCLI_BUILD_VERSION/$fileName"
    ...
    $indexContent = "Binaries/$env:DOTNETCLI_BUILD_VERSION/$fileName"
...
function UploadInstallers($msiFile)
{
    ...
    $msiBlob = "$env:CHANNEL/Installers/$env:DOTNETCLI_BUILD_VERSION/$fileName"
