...
function RunCandle
{
    ...
    .\candle.exe -dDotnetSrc="$inputDir" -dMicrosoftEula="$RepoRoot\packaging\osx\resources\en.lproj\eula.rtf" -dBuildVersion="$env:DOTNETCLI_BUILD_VERSION" -arch x64 `
...
$DotnetMSIOutput = Join-Path $PackageDir "dotnet-win-x64.$env:DOTNETCLI_BUILD_VERSION.msi"
